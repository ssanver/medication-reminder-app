...
export type AppIconName = 'home' | 'pill' | 'add' | 'settings' | 'back' | 'forward' | 'close' | 'check' | 'alarm' | 'calendar' | 'today';
  ...
  return (
    <View style={styles.icon}>
      <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        ...
        {name === 'calendar' ? (
          <>
            <Rect x="3.8" y="5.2" width="16.4" height="14.8" rx="2.8" stroke={color} strokeWidth={1.8} />
            <Path d="M3.8 9.8H20.2" stroke={color} strokeWidth={1.8} />
            <Path d="M8.1 3.6V6.5M15.9 3.6V6.5" stroke={color} strokeWidth={1.8} strokeLinecap="round" />
            <Rect x="8.2" y="12.2" width="3.2" height="3.2" rx="0.8" fill={color} />
          </>
        ) : null}
        {name === 'today' ? (
          <>
            <Circle cx="12" cy="12" r="8.1" stroke={color} strokeWidth={1.8} />
            <Path d="M12 8.1V12.2L14.8 14.2" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
          </>
        ) : null}
      </Svg>
    </View>
