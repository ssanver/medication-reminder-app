...
builder.Services.AddScoped<IMonetizationUserRepository, EfMonetizationUserRepository>();
builder.Services.AddScoped<IAppDefinitionsRepository, EfAppDefinitionsRepository>();
builder.Services.AddScoped<MonetizationApplicationService>();
